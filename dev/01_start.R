...
##
golem::fill_desc(
  pkg_name = "MyBrews", # The Name of the package containing the App
  pkg_title = "mybrews_dashboard", # The Title of the package containing the App
  pkg_description = "A dashboard showing visualisations and statistics for my homebrews. Data is gathered from Brewfather.", # The Description of the package containing the App
